...
msg_dev_2_del = msg_header + msg_stamp + msg_id_gw+dev_2_mac+dev_2_type+'\x0c\x00'+dev_status_len+dev_2_status

len = skt.send(msg_dev_2_del)
#msg_bak = skt.recv(1024)
#print msg_bak

msg_dev_2_reqstat = msg_header + msg_stamp + msg_id_gw+dev_1_mac+dev_2_type+'\x1b\x00'+dev_status_len+dev_2_status
len = skt.send(msg_dev_2_reqstat)
msg_bak = skt.recv(1024)
print msg_bak
