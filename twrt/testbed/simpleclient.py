...
msg_set_scene = msg_header+msg_stamp+msg_id_gw+msg_id_dev+msg_devtype+'\x0f\x00'+'\x00\x90' + scene_id_major+scene_id_minor+scene_mac+scene_type+scene_name+'\x01\x00\x00\x00'+'\x01\x00\x00\x00'+scene_trigger1+scene_item_extra+scene_item1+scene_item_extra

msg_update_scene = msg_header+msg_stamp+msg_id_gw+msg_id_dev+msg_devtype+'\x0f\x00'+'\x00\x90' + scene_id_major+scene_id_minor+scene_mac+scene_type+scene_name+'\x00\x00\x00\x00'+'\x02\x00\x00\x00'+scene_item1+scene_item_extra+scene_item2+scene_item_extra

msg_set_scene2 = msg_header+msg_stamp+msg_id_gw+msg_id_dev+msg_devtype+'\x0f\x00'+'\x00\x90' + scene_id_major2+scene_id_minor2+scene_mac2+scene_type+scene_name+'\x01\x00\x00\x00'+'\x01\x00\x00\x00'+scene_trigger1+scene_item_extra+scene_item1+scene_item_extra
